    ...
    <>
      ...
      <Container>
        <BackgroundOrbs>
          ...
          />
          <Orb
            color="radial-gradient(circle, #991b1b, transparent)"
            duration="25"
            delay="5"
            style={{
              top: "50%",
        ...
        <MainContent>
          ...
          <HeroSection>
            ...
            <Subtitle>
              Germany's top football league. Experience the famous "Yellow Wall"
              atmosphere and world-class football in the heart of Europe.
            </Subtitle>
          </HeroSection>
...
const Container = styled.div`
  min-height: 100vh;
  background: linear-gradient(-45deg, #2d1b2d, #4c1d1d, #2a1a1a, #3d2020);
